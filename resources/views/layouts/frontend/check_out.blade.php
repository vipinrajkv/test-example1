  ...
  <div class="row">
    <div class="col-xl-8 col-lg-8 mb-4">
      ...
      <div class="card shadow-0 border">
        <div class="p-4">
        <form name="proceedCheckOut" id="proceedCheckOut">
        ...
        @foreach ($userDetails as $userDetail)
          <div class="row">
            ...
            <div class="col-6 mb-3">
              ...
              <div class="form-outline">
                <input type="tel" id="typePhone"  name="last_name" value="{{ $userDetail->phone ? $userDetail->phone : '' }}" class="form-control" />
              </div>
            </div>
          ...
          <div class="row mb-3">
            <div class="col-lg-4 mb-3">
              ...
              <div class="form-check h-100 border rounded-3">
                <div class="p-3">
                  <input class="form-check-input" style="margin: 4px 0 0 36px;" type="radio" name="flexRadioDefault" id="flexRadioDefault1" checked />
            ...
            <div class="col-lg-4 mb-3">
              ...
              <div class="form-check h-100 border rounded-3">
                <div class="p-3">
                  <input class="form-check-input" style="margin: 4px 0 0 36px;" type="radio" name="flexRadioDefault" id="flexRadioDefault2" />
            ...
            <div class="col-lg-4 mb-3">
              ...
              <div class="form-check h-100 border rounded-3">
                <div class="p-3">
                  <input class="form-check-input" style="margin: 4px 0 0 36px;" type="radio" name="flexRadioDefault" id="flexRadioDefault3" />
